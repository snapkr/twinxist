...
class ScraperAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {
            'fields': ('name', 'scraped_obj_class', 'status', 'content_type')
        }),
        ('Maximum items', {
            'classes': ('collapse',),
            'fields': ('max_items_read', 'max_items_save')
        }),
        ('Pagination', {
            'classes': ('collapse',),
            'fields': ('pagination_type', 'pagination_on_start', 'pagination_append_str', 'pagination_page_replace',  'pagination_crawelerrule_xpath')
        }),
        ('Checker', {
            'classes': ('collapse',),
            'fields': ('checker_type', 'checker_x_path', 'checker_x_path_result', 'checker_ref_url')
        }),
        (None, {
            'fields': ('comments',)
        }),
