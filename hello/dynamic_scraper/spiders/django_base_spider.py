...
class DjangoBaseSpider(CrawlSpider):
    ...
    allowed_domains= []
    start_urls = []
    #rules = ( Rule (SgmlLinkExtractor(allow=(),restrict_xpaths=('//XPATH-HERE',)), callback="parse_page", follow= True), )
    ...
    def _compile_rules(self):
        print 'Compilerules aangeroepen'
        super(DjangoBaseSpider, self)._compile_rules()
